...
(cl:defmethod cl:initialize-instance :after ((m <ultraInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ultraInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacle_challenge-msg:<ultraInfo> is deprecated: use obstacle_challenge-msg:ultraInfo instead.")))

(cl:ensure-generic-function 'nums-val :lambda-list '(m))
(cl:defmethod nums-val ((m <ultraInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_challenge-msg:nums-val is deprecated.  Use obstacle_challenge-msg:nums instead.")
  (nums m))
